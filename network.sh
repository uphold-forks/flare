...
--state-connector-id=$(cat $(pwd)/keys/node00/scID.txt) &> $LOG_DIR/node00/nohup.out & echo $! > $LOG_DIR/node00/ava.pid
...
--state-connector-id=$(cat $(pwd)/keys/node01/scID.txt) &> $LOG_DIR/node01/nohup.out & echo $! > $LOG_DIR/node01/ava.pid
...
$(cat $(pwd)/keys/node02/nodeID.txt),\
$(cat $(pwd)/keys/node03/nodeID.txt) \
--state-connector-id=$(cat $(pwd)/keys/node02/scID.txt) &> $LOG_DIR/node02/nohup.out & echo $! > $LOG_DIR/node02/ava.pid
...
$(cat $(pwd)/keys/node02/nodeID.txt),\
$(cat $(pwd)/keys/node03/nodeID.txt) \
--state-connector-id=$(cat $(pwd)/keys/node03/scID.txt) &> $LOG_DIR/node03/nohup.out & echo $! > $LOG_DIR/node03/ava.pid
...
$(cat $(pwd)/keys/node03/nodeID.txt),\
$(cat $(pwd)/keys/node04/nodeID.txt) \
--state-connector-id=$(cat $(pwd)/keys/node04/scID.txt) &> $LOG_DIR/node04/nohup.out & echo $! > $LOG_DIR/node04/ava.pid
